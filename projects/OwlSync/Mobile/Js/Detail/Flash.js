export default App => {
	return new class {
		...
		Event(){
			App.Function.Request.Get(App.Language.L_72 , App.String.Concat('flash/detail/' , App.Storage.Session.Read('New')) , Detail => {
				this.Target.Wicket.append(App.String.Concat(`
					<div class="Method">
						` , (App.Verify.Empty(Detail.tags) ? App.String.Concat(`
							<img src="` , Detail.avatar , `" />
							<span>` , Detail.nickname , `</span>
						`) : App.String.Concat(`
							<img src="` , Detail.tags[0].logo , `" />
							<span>` , Detail.tags[0].name , `</span>
						`)) , `
					</div>
					<div class="Tool">
						<ul class="Quantity">
						...
						<div class="Time">` , App.Date.Full(Detail.publish_time) , `</div>
					</div>
					<div class="Title">` , Detail.title , `</div>
					<div class="Content">` , Detail.full_content , `</div>
					<div class="Foot">
