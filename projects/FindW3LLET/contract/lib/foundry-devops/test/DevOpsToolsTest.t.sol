...
contract DevOpsToolsTest is Test {
    address public constant EXPECTED_ADDRESS = 0xa513E6E4b8f2a923D98304ec87F64353C4D5C853;
    ...
    function testGetMostRecentlyDeployedContract() public {
        address mostRecentDeployment =
            DevOpsTools.get_most_recent_deployment(CONTRACT_NAME, CHAIN_ID, SEARCH_PATH, SCRIPT_PATH);
    ...
    function testGetMostRecentlyDeployedEvenWhenMultipleAreDeployed() public {
        ...
        address mostRecentDeployment =
            DevOpsTools.get_most_recent_deployment(contractName, chainId, SEARCH_PATH, SCRIPT_PATH);
