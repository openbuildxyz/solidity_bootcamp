...
| ------------------ | --------------------------------------------- |------------------ | ----------------------------- |  ---------------|
| Genius  | OpenLeaning  | 一个质押共学平台| 队员简介 |   |  合约：暴龙 / 前端：D  |
| 绿行链Web3 | EvCharingingApp  | 为新能源车的车主提供便利的加密货币支付手段促进人们选择绿色出现的方式，减少人们的碳排放。| 整体用hardhat开发链外数据使用chainlink的预言机提供服务 |  队员简介 |  Welk /黄艇  |
